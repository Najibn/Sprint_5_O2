...
import { createMaintenanceRecord } from '../../api/maintenanceRecords';
...
const CreateMaintenanceRecord = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [productList, userList] = await Promise.all([
          getProducts(),
          getUsers()
        ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Error creating maintenance record');
    }
  };
